...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('game_team', 'chat_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Team.chat'
        db.add_column('game_team', 'chat', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['chat.Chat']), keep_default=False)
