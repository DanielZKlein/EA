...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('game_game', 'max_players', self.gf('django.db.models.fields.IntegerField')(default=8), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Game.max_players'
        db.delete_column('game_game', 'max_players')
    ...
    models = {
        ...
        'game.game': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_players': ('django.db.models.fields.IntegerField', [], {'default': '8'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Lobby'", 'max_length': '10'})
        },
        'game.team': {
