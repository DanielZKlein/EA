...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Game.chat'
        db.delete_column('game_game', 'chat_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Game.chat'
        db.add_column('game_game', 'chat', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['chat.Chat']), keep_default=False)
