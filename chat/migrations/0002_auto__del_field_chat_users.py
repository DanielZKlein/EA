...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chat.users'
        db.delete_column('chat_chat', 'users_id')

        # Adding M2M table for field users on 'Chat'
        db.create_table('chat_chat_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('chat', models.ForeignKey(orm['chat.chat'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('chat_chat_users', ['chat_id', 'user_id'])
    
    
    def backwards(self, orm):
        
        # Adding field 'Chat.users'
        db.add_column('chat_chat', 'users', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['auth.User']), keep_default=False)

        # Removing M2M table for field users on 'Chat'
        db.delete_table('chat_chat_users')
